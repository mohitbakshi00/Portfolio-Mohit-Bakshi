...
const About = () => {
  return (
    <div
      name="about"
      className="w-full h-full py-8 bg-gradient-to-b from-gray-800 to-black text-white"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          <p className="text-4xl mx-2 font-bold inline border-b-4 border-gray-500">
            About Me
          </p>
        </div>

        <p className="text-xl text-justify mx-auto px-3">
